...
reported to the project maintainers by opening a confidential report
through GitHub (see `SECURITY.md` for the reporting process used for
sensitive matters). All complaints will be reviewed and investigated
promptly and fairly.
